...
public class Anagram extends Configured implements Tool {
	...
	public static class AnagramReducer extends Reducer<Text, Text, Text, Text> {
		...
		public void reduce(Text anagramKey, Iterable<Text> anagramValues, Context context)
	...
	public static void main(String[] args) throws Exception {
		// 数据的输入路径和输出路径
		String[] args0 = { "/test/test04/Anagram.txt", "/test/test04/output" };
